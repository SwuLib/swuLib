    ...
    <div class="container">
        ...
        <div class="agile-team-grids">
            <div class="col-md-3 team-grid">
                <div class="team-img">
                    <a href="#portfolioModal1" style="text-decoration: none"
                       class="b-link-stripe b-animate-go wow zoomIn animated" data-wow-delay=".5s" data-toggle="modal">
                        <img src="http://192.168.1.101:8080/image/heart2.jpg" class="img-responsive" alt=" "/>
            ...
            <div class="col-md-3 team-grid">
                <div class="team-img">
                    <img src="http://192.168.1.101:8080/image/tony3.jpg" class="img-responsive" alt=" "/>
                    <figcaption class="overlay">
                        <h5>Tony Wu</h5>
            ...
            <div class="col-md-3 team-grid">
                <div class="team-img">
                    <a href="#portfolioModal1" style="text-decoration: none"
                       class="b-link-stripe b-animate-go wow zoomIn animated" data-wow-delay=".5s" data-toggle="modal">
                        <img src="http://192.168.1.101:8080/image/heart3.jpg" class="img-responsive" alt=" "/>
                        <figcaption class="overlay">
                            <h5>Qiu Chao</h5>
                            <p>sit aspernatur aut odit</p>
                            <div class="w3l-social">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h3>个人简历</h3>
                            <hr>
                            <img src="http://192.168.1.101:8080/image/heart44.jpg" class="img-responsive img-centered"
                                 alt="">
